...
const INITIAL_AGENTS: Agent[] = [
  {
    ...
    lastActive: '2m ago',
    online: true,
    stats: { memory: '1.2GB', compute: '14.2 TFLOPs', latency: '12ms' },
    tasks: [
  ...
  },
  {
    ...
    lastActive: 'Just now',
    online: true,
    stats: { memory: '4.5GB', compute: '2.1 TFLOPs', latency: '450ms' },
    tasks: [
  ...
  },
  {
    ...
    lastActive: '5m ago',
    online: false,
    stats: { memory: '512MB', compute: '32.0 TFLOPs', latency: '1ms' },
    tasks: [
  ...
  {
    id: 'agent-4',
    name: 'Dataset Harvester',
    type: 'Analysis',
    status: 'Standby',
    efficiency: 72.1,
    lastActive: '2h ago',
    online: true,
    stats: { memory: '12GB', compute: '0.8 TFLOPs', latency: '1200ms' },
    tasks: []
  }
];
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <Badge variant="outline" className={`text-[8px] font-black tracking-widest border-none p-0 ${
                          agent.status === 'Active' ? 'text-green-400' :
                          agent.status === 'Analyzing' ? 'text-blue-400' :
                          agent.status === 'Working' ? 'text-purple-400' : 'text-white/20'
                        }`}>
                          {agent.status}
                        </Badge>
         ...
         <DialogContent className="bg-[#050505] border-white/5 text-white max-w-2xl w-[95vw] sm:w-full overflow-hidden rounded-3xl p-0">
            ...
            <div className="relative z-10">
               ...
               <div className="p-6 max-h-[60vh] overflow-y-auto space-y-4 custom-scrollbar">
                  {[
                    { name: 'X-Celerator', type: 'Trading', cost: '5.0 SOL', efficiency: '99.2%', desc: 'Ultra-low latency arbitrage node.' },
                    { name: 'Viral Mind', type: 'Social', cost: '2.5 SOL', efficiency: '92.5%', desc: 'Recursive social engineering and trend mapping.' },
                    { name: 'Fortress Core', type: 'Security', cost: '10.0 SOL', efficiency: '99.99%', desc: 'Post-quantum encryption and multi-sig guard.' },
                    { name: 'Insight Engine', type: 'Analysis', cost: '1.2 SOL', efficiency: '88.4%', desc: 'General purpose on-chain data harvester.' },
                  ].map((recruit, i) => (
                    <div key={i} className="bg-white/5 border border-white/5 rounded-2xl p-4 flex items-center justify-between hover:border-blue-500/30 transition-all group">
